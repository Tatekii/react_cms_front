...
import { QuestionOutlined, ArrowDownOutlined, ArrowUpOutlined, ReloadOutlined } from "@ant-design/icons";
			...
			<Card
				...
				title={
					<div className="home-menu">
						...
						<span className={isVisited ? "" : "home-menu-active"} onClick={handleChange(false)}>
							销售量
						</span>
					</div>
				}
